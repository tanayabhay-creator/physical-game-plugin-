...
if ! grep -q "2026-07-21-launch10" "${TARGET}/main.py"; then
...
echo "OK: $(grep -n '2026-07-21-launch10' "${TARGET}/main.py" | head -1)"
...
echo "  2. Plugin build must show: 2026-07-21-launch10"
